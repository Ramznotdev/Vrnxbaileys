...
console.log(
  ...
  chalk.hex('#a78bfa').italic('           M Y   B A I L E Y S  BY VRNX♡\n\n') +
  chalk.hex('#89CFF0').italic('     last updated • 27,mei,2026\n') +
  chalk.hex('#c084fc').italic('     Modification by vrnxofficial\n') +
  chalk.hex('#a78bfa').italic('           telegram: @vrnxofficial\n\n') +
